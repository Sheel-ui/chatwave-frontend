...
const AddPost = ({ selectedImage }) => {
  ...
  const [textAreaBackground, setTextAreaBackground] = useState('#181c1c');
          ...
          >
            ...
            {!postImage && (
              <>
                ...
                >
                  <div className="main" style={{ margin: textAreaBackground !== '#181c1c' ? '0 auto' : '' }}>
                    <div className="flex-row">
                      <div
                        ...
                        className={`editable flex-item ${textAreaBackground !== '#181c1c' ? 'textInputColor' : ''} ${
                          postData.post.length === 0 && textAreaBackground !== '#181c1c' ? 'defaultInputTextColor' : ''
                        }`}
