  ...
  return (
    <>
      <div className="profile-banner" data-testid="profile-banner-skeleton">
        <div className="profile-banner-image" style={{ border: '1px solid white', backgroundColor: '#181c1c' }}></div>
        <div className="profile-banner-data">
          <div className="profile-pic">
            <Skeleton baseColor="#181c1c" height={180} width={180} />
          </div>
          <div className="profile-name">
            <Skeleton baseColor="#181c1c" height={20} width={120} />
          </div>
        </div>
                ...
                {data.show && (
                  <li className="banner-nav-item" key={data.key}>
                    <div className="banner-nav-item-name ">
                      <Skeleton baseColor="#181c1c" height={20} width={20} />
                      <p className="title">
                        <Skeleton baseColor="#181c1c" height={20} width={50} />
                      </p>
                    </div>
                  </li>
                )}
